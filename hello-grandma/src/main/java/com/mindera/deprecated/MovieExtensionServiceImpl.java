...
/*String json = movieExtensionRepository.getMovieById(tmdbId, MediaType.APPLICATION_JSON, API_KEY);
        ...
        return movieExtensionRepository.getMovieDetailsByTmdbId(tmdbId, APPLICATION_JSON, API_KEY);
    }
...
/*String json = movieExtensionRepository.getMovieRecommendation(movieId, ACCEPT_HEADER, API_KEY);
        ...
        return movieExtensionRepository.getMovieRecommendationByTmdbId(movieId, ACCEPT_HEADER, API_KEY).getResults();
    }
...
/*String json = movieExtensionRepository.discoverMovies(1, "vote_average.desc", 100,
        ...
        return movieExtensionRepository.discoverMoviesWithFilters(1, "vote_average.desc", 100,
